    ...
    return (
        <Box component="footer" sx={{ py: 5 }}>
            <Container maxWidth="lg">
                <Reference title="Smart Contracts" link="https://github.com/oxheadalpha/smart-contracts"></Reference>
                <Reference title="Frontend" link="https://github.com/KStasi/fa2-deployer"></Reference>
                <Copyright />
            </Container>
        </Box>
    );
