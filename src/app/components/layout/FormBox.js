...
const validateInput = (admin, contractName, contractDescription, tokensString) => {
    if ([admin, contractName, contractDescription].some((str) => !str || str.trim() === "")) return false;
    if (
...
const FormBox = () => {
    ...
    }, [setFetching, Tezos.wallet, tokensString, admin, contractName, contractDescription, tokenType, tokens]);
    return (
        <Paper
            component="form"
            onSubmit={(event) => {
        ...
        >
            <Stack direction="column" alignItems="center" spacing={2}>
                <FormField label="Admin" onChange={(e) => setAdmin(e.target.value)}></FormField>
                <FormField label="Contract name" onChange={(e) => setContractName(e.target.value)}></FormField>
                <FormField
